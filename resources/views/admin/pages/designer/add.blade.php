                                ...
                                <div class="row pt-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="avg_rating" id="avg_rating" class="form-control" placeholder="Avg Rating ">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="total_rating" id="total_rating" class="form-control" placeholder="Total Rating ">
                                        </div>
                                    </div>
